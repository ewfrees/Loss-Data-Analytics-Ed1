...
It is also noteworthy that if the conditional mean $\mathrm{E}(\mu(\theta)|X_1,...,X_n)$ is linear in the past observations, then the B&uuml;hlmann credibility estimate will coincide with the Bayesian estimate. More information about exact credibility can be found in [@buhlmanngisler], [@klugman2012], and [@tse].
