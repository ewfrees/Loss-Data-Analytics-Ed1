...
```{r, animation.hook='gifski', eval = ANIMATION, echo=ShowCode()}
pic_ani = function(k){
...
```{r, animation.hook='gifski', warning=FALSE, eval = ANIMATION, echo=ShowCode()}
pic_ani = function(k){
  plot(cars)
  v <- predict(model_poisson, newdata=data.frame(speed=u), type="response")
...
```{r, warning=FALSE, comment=FALSE, echo=ShowCode()}
par(mfrow=c(1,2))
...
```{r eval = ANIMATION, echo=ShowCode()}
...
```{r, warning=FALSE, comment=FALSE, eval = ANIMATION, echo=ShowCode()}
par(mfrow=c(1,2))
...
```{r, comment=FALSE, warning=FALSE, eval = ANIMATION, echo=ShowCode()}
