...
```{r InverseDFboot, fig.cap='Inverse of an Empirical Distribution Function', out.width='60%', fig.asp=.75, fig.align='center', echo=FALSE, cache = TRUE}
plot.new()
par(cex=1.3)
set.seed(1)
...
```{r InverseDFboot2, fig.cap='Inverse of an Empirical Distribution Function', out.width='60%', fig.asp=.75, fig.align='center', echo=FALSE, cache = TRUE}
plot.new()
par(cex=1.3)
set.seed(1)
x <- sort(c(0,rexp(10, 1/6)))
...
```{r BootstrapCompare, fig.cap='Comparision of Estimates. True value of the parameter is given by the solid horizontal line at 5.20.', fig.align='center',  comment="", echo=SHOW_PDF, cache = TRUE}
...
```{r CoefVarCompare, fig.cap='Comparision of Nonparametric and Parametric Bootstrap Distributions for the Coefficient of Variation', fig.align='center',  comment="", echo=SHOW_PDF, cache = TRUE}
