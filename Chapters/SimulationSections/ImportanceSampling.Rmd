...
```{r animation.hook='gifski', eval = ANIMATION, comment = "", fig.align='center', out.width='50%', fig.asp=.75, echo=SHOW_PDF}
mu = 2.5
sigma = 1
a = 2
b = 4
...
```{r sampleani1, animation.hook='gifski', fig.cap='Animated Demonstration of Draws In and Outside of (2,4)', eval = ANIMATION, comment = "", fig.align='center', out.width='50%', fig.asp=.75, echo=SHOW_PDF}
...
$$
F^{\star}(x) = \Pr(X \le x | a \lt X \le b) =\frac{F(x)-F(a)}{F(b)-F(a)}, \ \  \ \text{for } a \lt x \le b .
$$
...
```{r sampleani_IS_1, animation.hook='gifski', eval = ANIMATION, comment = "", fig.align='center', out.width='50%', fig.asp=.75, echo=SHOW_PDF}
for (i in 1:numAnimation) {pic_ani()}
```
