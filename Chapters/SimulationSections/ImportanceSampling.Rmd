...
```{r sampleani1, animation.hook=ANIMATIONHOOK, fig.cap='Animated Demonstration of Draws In and Outside of (2,4)', eval = ANIMATION, comment = "", fig.align='center', out.width='50%', fig.asp=.75, echo=SHOW_PDF, cache = TRUE}
