...
The `r Gloss('collective risk model')` represents the aggregate losses in terms of a `r Gloss('frequency distribution')` and a `r Gloss('severity distribution')`:
$$\begin{aligned}
S_N=X_1 +X_2 +\cdots+X_N.
\end{aligned}$$
