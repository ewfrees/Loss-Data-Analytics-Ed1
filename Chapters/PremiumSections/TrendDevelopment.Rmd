...
\@ref(fig:Exposures) presents four illustrative policies. Because of these differing start and end times, there needs to be some standards as to what types of measures are most useful for summarizing experience in a given reporting period.
