...
## Technical Supplement 7.A. Rate Regulation {#S:RateRegulation}

```{r child = 'Chapters/PremiumSections/RateRegulation.Rmd'}
```


## Technical Supplement 7.B. Selecting Rating Factors {#S:SelectingRateFactors}

```{r child = 'Chapters/PremiumSections/RateFactorSelection.Rmd'}
```

## Technical Supplement 7.C. Adverse Selection {#S:AdverseSelection}
