...
```{r IntroPlot, fig.cap='Scatter plot of *(Coverage,Claim)* from LGPIF data',echo=FALSE, warning=FALSE, out.width='80%', fig.asp=.75, fig.align='center'}
library(ggplot2)
...
= \frac{\widehat{Cov}(X,Y)}{\sqrt{\widehat{Var}(X,X)}\sqrt{\widehat{Var}(Y,Y)}}.
$$
...
```{r  Scatter, message=FALSE, echo=FALSE, out.width='80%', fig.align='center',fig.cap='Scatter plot of LOSS and ALAE'}
library(copula)
...
```{r Hist, message=FALSE, warning=FALSE, comment=FALSE, out.width='60%', echo=FALSE, fig.align='center', fig.cap='Histogram of Transformed ALAE'}
hist(u1, main="", xlab="" )
```
...
```{r Hist2, message=FALSE, warning=FALSE, comment="", echo=FALSE, out.width='80%', fig.align='center',fig.cap='Histogram of Transformed Loss. The left-hand panel shows the distribution of probability integral transformed losses. The right-hand panel shows the distribution for the corresponding normal scores.'}
...
```{r Scatter2, message=FALSE, warning=FALSE, comment="", echo=FALSE, out.width='80%', fig.align='center', fig.cap='Left: Scatter plot for transformed variables.  Right:Scatter plot for normal scores'}
par(mfrow = c(1, 2))
...
```{r FrankCop, message=FALSE, warning=FALSE, comment="", echo=FALSE, fig.align='center', fig.cap='Left: Plot for distribution function for Franks Copula. Right:Plot for density function for Franks Copula '}
#par(mfrow=c(1,2))
...
```{r Bounds, message=FALSE, warning=FALSE, comment="", out.width='60%', echo=FALSE, fig.align='center', fig.cap='Perfect Positive and Perfect negative dependence plots'}
set.seed(1980)
U <- runif(100)
par(mfrow=c(1, 2))
...
```{r DepTails, message=FALSE, warning=FALSE, comment="", out.width='80%', echo=FALSE, fig.align='center',fig.cap='Tail dependence plots'}
